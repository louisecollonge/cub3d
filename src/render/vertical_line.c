...
/*   Updated: 2025/03/21 19:52:29 by amonfret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	stripe_loop(mlx_image_t *img, int x,
	t_render_data *data, TEX *texture)
{
	int				y;
...
void	draw_texture_stripe(mlx_image_t *img, int x, t_game *game,
	t_render_data *render_data)
{
	...
	render_data->tex_pos = (render_data->draw_start - HEIGHT / 2
			+ (render_data->draw_end - render_data->draw_start) / 2.0)
		* render_data->step;
